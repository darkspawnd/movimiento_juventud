    ...
    <div class="form-wrapper teatro">
        ...
        <div class="form-row">
            <input type="text" class="form-control" placeholder="Nombre Del Director del Grupo Teatral" name="direccion_representante"/>
        </div>
        <div class="form-row">
            <input type="text" class="form-control" placeholder="Duracion" name="duracion_obra"/>
        </div>
        <div class="form-row">
            <input type="text" class="form-control" placeholder="Telefono/Celular" name="telefono_representante"/>
        </div>
        <div class="form-row">
            <input type="text" class="form-control" placeholder="Email Director"  name="mail_representante"/>
        </div>
