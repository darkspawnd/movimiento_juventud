<!-- Formulario Coros -->
    ...
    <div class="cover top no-padding">
        <img class="cover" src="http://localhost:8888/www.movimientojuventud.com.gt/assets/images/arteycultura.jpg">
    </div>
    <div class="form-wrapper">
        ...
        <div class="form-row">
            <input type="text" class="form-control" placeholder="Nombre del Representante del Grupo" name="direccion_representante"/>
        </div>
        <div class="form-row">
            <input type="text" class="form-control" placeholder="Telefono/Celular" name="telefono_representante"/>
        </div>
        <div class="form-row">
            <input type="text" class="form-control" placeholder="Email Representante"  name="mail_representante"/>
        </div>
